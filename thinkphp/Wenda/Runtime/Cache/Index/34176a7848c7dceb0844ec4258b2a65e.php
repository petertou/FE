...
<head>
	...
	<link rel="stylesheet" href="/Wenda/Public/Index/Css/ask.css" />
	<script type="text/javascript">
		var URL = "/Index/Ask";
		var on = false;
		<?php if(isset($_SESSION['uid']) && isset($_SESSION['user'])): ?>on=true;<?php endif; ?>
		var point = <?php echo ($point); ?>;
	</script>
	<script type="text/javascript" src="/Wenda/Public/Index/Js/ask.js"></script>
</head>
<body>
	<!-- top -->
<!-- top -->
...
<!-- top结束 -->
	<div id='location'>
		<a href="/Index/index/index">后盾问答</a>&nbsp;>&nbsp;提问
	</div>
		...
		<div class='send'>
			...
			<form action="<?php echo U('send');?>" method='post'>
				...
				<div class='reward'>
					...
					<ul>
						<li>
							<?php if(isset($_SESSION['uid']) && isset($_SESSION['user'])): ?>我的金币：<span><?php echo ($point); ?></span><?php endif; ?>
						</li>
						<li>
