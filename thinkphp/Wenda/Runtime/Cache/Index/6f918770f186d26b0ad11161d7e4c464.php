...
<!-- 左侧结束 -->
		<div id='right'>
			<p class='title'><?php echo ($role); ?>的金币</p>
			<p class='lv-info'>
					<?php if($reward == null): ?>您还没有金币，赶紧向着高富帅去奋斗吧！
					<?php else: ?>
					您现有金币<span><?php echo ($reward); ?></span><?php endif; ?>
			</p>
			<div class='lv-rule'>
				<p><span>金币获取</span></p>
				<table class='lv-exp'>
					...
					<tr>
						<td>采纳回答被删除</td>
						<td>提问者：-<?php echo (C("DEL_ACCEPT_Answer")); ?>金币&nbsp;&nbsp;回答者：-<?php echo (C("DEL_ACCEPT_Ask")); ?>金币</td>
					</tr>
				</table>
			</div>
		</div>
