...
<head>
	...
	<link rel="stylesheet" href="/Wenda/Public/Index/Css/face.css">
...
<!-- 左侧结束 -->
		<div id='right'>
			...
			<div class='imgface_box'>
				<img src="<?php if($faces): ?>/Upload/Face/<?php echo ($faces); ?> <?php else: ?>/Wenda/Public/Index/Images/noface.gif<?php endif; ?>" id="preview">
				<form action="<?php echo U('Member/faces',array('id'=>$_GET['id']));?>" method="POST" enctype="multipart/form-data">
