...
<body>
<form action="<?php echo U('Admin/Reward/edit');?>" method="post">
	<table class="table">
		<tr>
			...
			<tr>
				...
				<td>
					<input type="radio" name="RES_ON" value="1" <?php if(C('RES_ON')): ?>checked='checked'<?php endif; ?>/>开启
					<input type="radio" name="RES_ON" value="0" <?php if(!C('RES_ON')): ?>checked='checked'<?php endif; ?>/>关闭
				</td>
			</tr>
			<tr>
				<td align='right'>网站状态：</td>
				<td>
					<input type="radio" name="WEB_ON" value="1" <?php if(C('WEB_ON')): ?>checked='checked'<?php endif; ?>/>开启
					<input type="radio" name="WEB_ON" value="0"  <?php if(!C('WEB_ON')): ?>checked='checked'<?php endif; ?>/>关闭
				</td>
			</tr>
			<tr>
